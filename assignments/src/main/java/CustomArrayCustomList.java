...
public class CustomArrayCustomList<E> implements CustomListInterface<E> {
    ...
    /**
     * Element list constructor, takes in variable number of objects and creates and underlying
     ...
     * need to shift the remaining elements up in the index order to fill the gap
